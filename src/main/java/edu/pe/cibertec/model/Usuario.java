...
public class Usuario {
	...
	public Usuario(int codUsuario, String nombUsuario, String apeUsuario, String emaUsuario) {
		super();
		this.codUsuario = codUsuario;
		this.nomUsuario = nombUsuario;
		this.apeUsuario = apeUsuario;
		this.emaUsuario = emaUsuario;
	}
	
	public Usuario(String nombUsuario, String apeUsuario, String emaUsuario) {
		super();
		this.nomUsuario = nombUsuario;
		this.apeUsuario = apeUsuario;
		this.emaUsuario = emaUsuario;
